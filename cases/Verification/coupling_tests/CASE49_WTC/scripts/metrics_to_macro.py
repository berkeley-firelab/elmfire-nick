...
EXPECTED_METRICS = {
    ...
    "low-HRR positive sampled FBFM91 cell-step energy",
    "high-HRR positive sampled FBFM91 cell-step energy",
    "maximum logged solver-step deviation",
    "finest-pair landmark TOA relative L2 change",
    "finest-pair community ROS relative change",
    "high-HRR finest-pair total-heat relative change",
    "low-HRR finest-pair total-heat relative change",
    "landmark TOA observed temporal order",
    "community ROS observed temporal order",
    "high-HRR heat observed temporal order",
    "low-HRR heat observed temporal order",
    "minimum high-HRR TOA-fit coefficient of determination",
}
