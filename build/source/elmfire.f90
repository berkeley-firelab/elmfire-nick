...
IF (MODE .EQ. 1 .OR. MODE .EQ. 3) THEN
   ...
   R=>ASP
   IF (DUMP_EMBER_FLUX .OR. (ENABLE_SPOTTING .AND. trim(ACCUMULATION_MODEL) .eq. 'EULERIAN')) THEN
...
IF (MODE .NE. 2) THEN
   ...
   DO WHILE (DONE_CASES .LT. NUM_CASES_TOTAL)
      ...
      if (ENABLE_SPOTTING .and. GENERATION_MODEL .eq. 'PER-AREA' .or. GENERATION_MODEL .eq. 'PER-MW') USE_UMD_SPOTTING_MODEL = .TRUE.
