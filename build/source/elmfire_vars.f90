...
REAL :: ANALYSIS_CELLSIZE, ANALYSIS_XLLCORNER, ANALYSIS_YLLCORNER, BLDG_AREA_CONSTANT, BLDG_FOOTPRINT_FRAC_CONSTANT, &
        ...
        WIND_SPEED_FLUCTUATION_INTENSITY, WSMFEFF_LOW_MULT, HRR_ELLIPSE_ADJ
...
LOGICAL :: USE_UMD_SPOTTING_MODEL, USE_PHYSICAL_SPOTTING_DURATION, USE_PHYSICAL_EMBER_NUMBER, USE_EULERIAN_SPOTTING, &
           NO_SURFACE_FIRE, USE_EMBER_IGNITION_MODEL, USE_SIMPLE_IGNITION_MODEL, USE_CUSTOMIZED_PDF, DIFF_WILDLAND_IGNITION, &
...
REAL :: CRITICL_HF_WUI ! Critical heat flux for sustain structure burning
...
LOGICAL*1, ALLOCATABLE, DIMENSION(:,:) :: TAGGED_WUI, EVERTAGGED_WUI
