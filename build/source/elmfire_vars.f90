...
LOGICAL :: ACCUMULATE_EMBER_FLUX, CONVERT_TO_GEOTIFF, DUMP_AFFECTED_LAND_VALUE, DUMP_AFFECTED_POPULATION, &
           ...
           FULL_BINARY_OUTPUTS, USE_FOUR_DIGITS_IN_IWX_BAND, SPREAD_RATE_IN_M
...
#ifdef _WUI
LOGICAL :: DUMP_TOTAL_DFC_RECEIVED, DUMP_TOTAL_RAD_RECEIVED, DUMP_HRR_TRANSIENT, DUMP_FUEL_CONSUMPTION, &
