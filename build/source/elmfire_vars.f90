...
INTEGER :: CROWN_FIRE_MODEL, FEEDBACK_LEVEL, MODE, NUM_IGNITIONS, NUM_NODES_OMP_THRESHOLD, UNTAG_CELLS_TIMESTEP_INTERVAL
...
INTEGER :: BANDTHICKNESS_WUI
REAL :: HRR_ELLIPSE_ADJ, CRITICAL_HF_WUI ! Critical heat flux for sustain structure burning
