...
WSMFEFF_LOW_MULT, WX_BILINEAR_INTERPOLATION, WX_BANDS_KEPT_IN_MEM, CLEAN_SCRATCH, T_LINE_IGN, X_LINE_IGN, Y_LINE_IGN
...
USE_CROSSWIND_DISTRIBUTION, GENERATION_MODEL, TRANSPORT_MODEL, ACCUMULATION_MODEL, IGNITION_MODEL

IF (IRANK_WORLD .EQ. 0) WRITE(*,*) 'Reading &SPOTTING namelist group'


GENERATION_MODEL     = '' ! 'UNIFORM' or 'PER-AREA' or 'PER-MW'  
TRANSPORT_MODEL      = '' ! 'UNIFORM' or 'LOGNORMAL' or 'SARDOY'
ACCUMULATION_MODEL   = '' ! 'PROBABILISTIC' or 'PHYSICAL'
IGNITION_MODEL       = '' ! 'DIRECT' or 'SIMPLE' or 'PHYSICAL'
