...
# -*- coding: utf-8 -*-
"""
Shared scientific implementation from the original ELMFIRE GUIDE harness.
...
TEMPLATE_DIR = HERE  # Kept local so this case has no suite-level runtime dependency.
